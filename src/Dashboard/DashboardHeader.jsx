                        ...
                        <div className="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul className="navbar-nav ms-auto  mb-2 ">
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="/main">Dashboard</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="/activity">Activity</Link>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="/addMoney">Add Money</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link active" aria-current="page" to="/withdrawl">Withdraw Money</Link>
                                </li>
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><Link className="dropdown-item" to="/update"><svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512">
                                        ...
                                        </svg> Update Profile</Link></li>
                                        <li><Link className="dropdown-item" to="/cpass"><svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512">
                                        ...
                                        </svg> Change Password</Link></li>
                                        <li><Link
                                            onClick={() => {
                                                localStorage.removeItem('token')
                                            }}
                                            className="dropdown-item" to="/"><svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 512 512">
